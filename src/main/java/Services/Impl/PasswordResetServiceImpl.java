...
public class PasswordResetServiceImpl implements PasswordResetService {
    ...
    public PasswordResetToken sendToken(User user) {
        ...
        LocalDateTime expirationTime = createdTime.plusMinutes(Constants.Security.PASSWORD_RESET_TOKEN_LIVE_TIME_IN_MINUTE);
        ...
        String link = CommonConstant.FULL_DOMAIN + "/auth/resetPassword?id=" + newTokenId;
